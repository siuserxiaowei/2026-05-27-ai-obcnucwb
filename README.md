...
2026-05-27 AI 主题归档：自动生成的飞书纪要 GitHub Pages 页面。

English summary: 2026-05-27 AI topic archive, an auto-generated Feishu Minutes GitHub Pages site.

### Online Entry Points

- GitHub repository: https://github.com/siuserxiaowei/2026-05-27-ai-obcnucwb
- Live / GitHub Pages: https://siuserxiaowei.github.io/2026-05-27-ai-obcnucwb/
- Default branch: `main`
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-27-ai-obcnucwb.git
cd 2026-05-27-ai-obcnucwb
```
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnucwbf9g5hbr1z37g72h4
- 模板：wiki
- 页面：`docs/index.html`
